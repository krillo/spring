	...
	<p><em><?php _e('Only required if your group is in Dynamic or Block mode.', 'adrotate'); ?></em></p>
   	<table class="widefat" style="margin-top: .5em">
	    ...
	    <tr>
			...
			<td>
				<label for="adrotate_admargin_top">Top: <input tabindex="8" name="adrotate_admargin_top" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin; ?>" autocomplete="off" /> Bottom: <input tabindex="8" name="adrotate_admargin_bottom" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin_bottom; ?>" autocomplete="off" /> Left: <input tabindex="8" name="adrotate_admargin_left" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin_left; ?>" autocomplete="off" /> Right: <input tabindex="8" name="adrotate_admargin_right" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin_right; ?>" autocomplete="off" /> <?php _e('pixel(s)', 'adrotate'); ?>.</label>
			</td>
			<td colspan="2">
		        <p><em><?php _e('A transparant border outside the advert in pixels. Default: 1.', 'adrotate'); ?></em><br /><em><?php _e('Only used for Dynamic and Block mode.', 'adrotate'); ?></em></p>
			</td>
		</tr>
		</tbody>
	</table>
	...
	<h3><?php _e('Advanced', 'adrotate'); ?></h3>
   	<table class="widefat" style="margin-top: .5em">
	    ...
	    <tr>
			...
			<td width="35%"><label for="adrotate_geo"><input tabindex="9" type="checkbox" name="adrotate_geo" value="1" <?php if($edit_group->geo == '1') { ?>checked="checked"<?php } ?> /> <?php _e('Enable GeoTargeting for this group.', 'adrotate'); ?></label></td>
	    ...
	    <tr>
			...
			<td>
				...
				<select tabindex="10" name="adrotate_fallback">
