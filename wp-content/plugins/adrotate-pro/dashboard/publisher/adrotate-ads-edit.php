...
$schedules = $wpdb->get_results("SELECT `id`, `name`, `starttime`, `stoptime`, `maxclicks`, `maximpressions` FROM `".$wpdb->prefix."adrotate_schedule` WHERE `name` != '' AND `stoptime` > $now ORDER BY `id` ASC;");
...
if($adrotate_debug['track'] == true) {
	$trackmeta = "$edit_banner->id,0,0,1,$blog_id";
} else {
	$trackmeta = base64_encode("$edit_banner->id,0,0,1,$blog_id");
}
...
<?php } ?>
	...
	<table class="widefat" style="margin-top: .5em">
		<tbody>
      	...
      	<tr>
	        ...
	        <td colspan="3"><?php echo plugins_url(); ?>/adrotate-pro/library/clicktracker.php?track=<?php echo $trackmeta; ?></td>
      	</tr>
      	</tbody>
	</table>
	...
	<table class="widefat" style="margin-top: .5em">			
	    ...
	    <tr>
			...
			<td colspan="2"><textarea tabindex="14" name="adrotate_geo_cities" cols="65" rows="3"><?php echo (is_array($cities)) ? implode(', ', $cities) : ''; ?></textarea></td>
			<td>
	...
	<p><em><?php _e('Create a schedule here if no appropriate one one is listed below.', 'adrotate'); ?></em></p>
	<table class="widefat" style="margin-top: .5em">
     	<tr>
	...
	<table class="widefat" style="margin-top: .5em">
		...
		<tr>
	        ...
	        <th width="12%"><center><?php _e('This ad used', 'adrotate'); ?></center></th>
		...
		?>
      	<tr id='schedule-<?php echo $schedule->id; ?>' class='<?php echo $activeclass.$class; ?>'>
	...
	<table class="widefat" style="margin-top: .5em">
		...
		<tbody>
      	...
      	<tr>
	        ...
	        <td colspan="3">
		        <input tabindex="33" name="adrotate_timeframelength" type="text" size="5" class="search-input" autocomplete="off" value="<?php echo $edit_banner->timeframelength;?>" /> <select tabindex="34" name="adrotate_timeframe">
      	...
      	<tr>
	        <th><?php _e('Maximum clicks:', 'adrotate'); ?></th>
	        <td>
		        <label for="adrotate_timeframeclicks"></label><input tabindex="35" name="adrotate_timeframeclicks" type="text" size="5" class="search-input" autocomplete="off" value="<?php echo $edit_banner->timeframeclicks;?>" /> <em><?php _e('Leave empty or 0 to skip this.', 'adrotate'); ?></em></label>
	        </td>
	        <th valign="top"><?php _e('Maximum impressions:', 'adrotate'); ?></th>
	        <td>
		        <label for="adrotate_timeframeimpressions"><input tabindex="36" name="adrotate_timeframeimpressions" type="text" size="5" class="search-input" autocomplete="off" value="<?php echo $edit_banner->timeframeimpressions;?>" /> <em><?php _e('Leave empty or 0 to skip this.', 'adrotate'); ?></em></label>
	        </td>
      	</tr>
		</tbody>					
