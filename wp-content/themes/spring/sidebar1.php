...
<div class="col-sm-6 column" id="sidebar1">
  ...
  <?php global $spp;
  if (method_exists($spp, 'printPrenpuff')) $spp->printPrenpuff(); ?>
  <!-- tabs -->
  <div id="social-tab">
    <div class="tabbable">
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="facebook-tab">
          <!-- Facebook iframe -->
          <div class="fb-like-box" data-href="https://www.facebook.com/magasinspring" data-width="262px" data-height="540" data-colorscheme="light" data-show-faces="true" data-header="false" data-stream="true" data-show-border="true"></div>
          <!-- Facebook iframe end -->
        </div>
